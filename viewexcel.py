...
class ViewExcel:
    def __init__(self, master):
        ...
        self.view_button = tk.Button(self.master, text="Last Update", command=self.view_excel)
...
class ViewExcel:
    def __init__(self, master):
        ...
        self.view_button = tk.Button(self.master, text="View Excel", command=self.speak_last_updated)
        self.view_button.grid(row=3, column=0, padx=5, pady=5, sticky=tk.EW)

        self.edit_button = tk.Button(self.master, text="Edit Excel", command=self.edit_excel)
        self.edit_button.grid(row=3, column=1, padx=5, pady=5, sticky=tk.EW)
    ...
    def speak_last_updated(self):
        ...
        if selected_index:
            ...
            # Speak the last modified time
            self.engine.say(f"The file was last updated on {last_modified_time.strftime('%Y-%m-%d %H:%M:%S')}")
