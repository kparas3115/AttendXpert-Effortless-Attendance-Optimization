...
class LoopRunner15(tk.Tk):
    def __init__(self):
        ...
        self.roll_count = 47  # Start at roll number 47
    ...
    def present_action(self):
        if self.roll_count <= 70:  # End at roll number 70
            self.roll_count += 1
    ...
    def backward(self):
        if self.roll_count > 47:  # Start at roll number 47
            self.roll_count -= 1
            self.roll_label.config(text=str(self.roll_count))

    def forward(self):
        if self.roll_count <= 70:  # End at roll number 69
            self.roll_count += 1
            self.roll_label.config(text=str(self.roll_count))
